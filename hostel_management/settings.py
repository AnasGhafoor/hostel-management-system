...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',   # project folder ke andar ek db.sqlite3 file banegi
    }
}
...
# ---------------------------
LOGIN_URL = 'login'               # Agar login na ho to redirect karega
LOGIN_REDIRECT_URL = 'home'       # Login ke baad home page par bhejega
LOGOUT_REDIRECT_URL = 'login'     # Logout ke baad login page par bhejega
